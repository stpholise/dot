...
const Successfull = ({ id }: { id?: string }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-8 bg-white rounded-lg  max-w-md ">
      ...
      <p className="text-[#667085] text-base font-medium text-center w-99">
        Use the unique id below to complete repayment at any DotPay agent store
        closest to you.
      </p>
      <div className="bg-gray-100 px-4 py-2.5 mt-4 rounded-md text-black w-82 flex justify-between items-center">
        <p className="text-lg font-medium">DLTE-{id}</p>
        <button
