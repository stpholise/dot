...
export const remittanceColumn: ColumnDef<DummyRemittance>[] = [
    ...
    cell: (cell) => {
      ...
      return (
        <div className="w-full">
          <div className="text-black hidden lg:table-cell sm:text-[#667085]   lg:w-full px-4 py-4 ">
           <p className=" "> {value}</p>
          </div>
          <div className="text-gray-900 lg:hidden  w-11/12 mx-auto my-2">
            <div className="bg-[#f9f9f9] border border-[#EAEAEA] w-full rounded-t-2xl px-6 py-4 flex justify-between">
              ...
              <button className="w-40 h-12 rounded-lg bg-white border border-[#eaeaea] font-medium text-[#344054] text-base">
                View Details
              </button>
            </div>
            <div className="w-full h-24 flex items-center px-6 py-6 border-[#eaeaea] border rounded-b-lg">
              <div className="flex-1">
                <p className="text-[#667085] text-xs leading-8">Remittance Amount</p>
              ...
              <div className="flex-1 text-right ">
                <p className="text-[#667085] text-xs px-3 leading-8">Status</p>
                  ...
                  <div className={`ml-auto flex items-center justify-end gap-2 w-fit rounded-2xl px-3 py-1 text-[#454547] text-sm ${color} `}>
                    <div
                      className={clsx(
                        "rounded-full size-1",
                        remittanceStatus === "Submitted"
  ...
  },
  {
    ...
    cell: (cell) => {
      const value = cell.getValue() as string;
      return (
        <div className="hidden lg:flex justify-end w-full lg:w-full  text-right  px-4 py-4">
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="hidden lg:flex text-[#667085] px-4 py-4">
  ...
  },
  {
    ...
    cell: () => {
      return <div className="text-[#667085] hidden lg:table-cell px-4 py-4 ">...</div>;
    },
  },
];
