...
const CheckCreditForm = () => {
  ...
  const validationSchema = Yup.object({
    ...
    specialFoodOccurance: Yup.string().required().oneOf(['Always Regular', 'Mostly Regular', 'Sometimes Irregular', 'Frequently Irregular','Rarely Regular']),
    householdFeeding: Yup.string().required(),
    householdCondition: Yup.string().required().oneOf([]),
  });
          ...
          <Form>
            <div className="lg:px-8 py-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  <option value=""></option>
                  <option value={"Always Regular"}>Very Regular – Meals are always on time</option>
                  <option value="Mostly Regular">Regular – Meals are mostly on time, with minor variations</option>
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  <option value=""></option>
                  <option value={"Excellent"}>Excellent - No visible issues</option>
